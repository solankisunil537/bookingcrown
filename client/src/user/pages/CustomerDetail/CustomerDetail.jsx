            ...
            <Skeleton loading={loading} active>
                {!loading && (
                    <div>
                                    ...
                                    <div className="flex h-16 items-center justify-between">
                                        ...
                                        <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-3">
                                            <i className="text-themeColor">
                                                <IoCall className="text-[16px] sm:text-[18px] md:text-[23px]" />
                                            </i>
                                            <p className="text-[12px] sm:text-[13px] md:text-[15px] text-slate-400">
                                                <a
                                                    href={`tel:+91${booking?.ownerData?.mobilenu}`}
                                                    target="_blank"
                        ...
                        <div className="h-screen mx-auto px-4 sm:px-6 md:px-12 lg:px-20 py-8 lg:py-10">
